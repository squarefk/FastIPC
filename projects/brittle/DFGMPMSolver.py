        ...
        for I in ti.grouped(self.pid):
            ...
            if self.useAnisoMPMDamageList[p] and self.useDFG:
                ...
                if ti.static(self.dim == 2):
                    ...
                    e, v1, v2, v3 = eigenDecomposition3D(kirchoff / J, 1) #use my eigendecomposition, comes out as four 3D vectors 
    ...
    def momentumP2GandComputeForces(self):
        ...
        for I in ti.grouped(self.pid):
            ...
            if ti.static(self.dim == 2):
                ...
                e, v1, v2, v3 = eigenDecomposition3D(kirchoff / J, 2) #use my eigendecomposition, comes out as four 3D vectors
                    ...
                    if self.useAnisoMPMDamage:
                        ...
                        if self.percentStretch > 0:
                            ...
                            if ti.static(self.dim == 2):
                                ...
                                e, v1, v2, v3 = eigenDecomposition3D(stretchKirchoff / stretchJ, 3)
                    ...
                    if self.useRankineDamage:
                        ...
                        if self.percentStretch > 0:
                            ...
                            if ti.static(self.dim == 2):
                                ...
                                e, v1, v2, v3 = eigenDecomposition3D(stretchKirchoff / stretchJ, 4)
                                stretchedSigma = e[0] #max in 3D
